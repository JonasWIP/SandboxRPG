...
namespace SpacetimeDB.Types
{
    ...
    public sealed partial class RemoteTables : RemoteTablesBase
    {
        public RemoteTables(DbConnection conn)
        {
            ...
            AddTable(DamageEvent = new(conn));
            AddTable(FurnaceState = new(conn));
            AddTable(HelloWorldMessage = new(conn));
            AddTable(InventoryItem = new(conn));
            AddTable(Npc = new(conn));
            AddTable(NpcConfig = new(conn));
            AddTable(NpcLootTable = new(conn));
            AddTable(NpcSpawnRule = new(conn));
            AddTable(NpcTradeOffer = new(conn));
            AddTable(PlacedStructure = new(conn));
            AddTable(Player = new(conn));
            AddTable(ServiceIdentity = new(conn));
    ...
    public sealed class QueryBuilder
    {
        ...
        internal static string[] AllTablesSqlQueries() => new string[]
        {
            ...
            new QueryBuilder().From.DamageEvent().ToSql(),
            ...
            new QueryBuilder().From.NpcConfig().ToSql(),
            new QueryBuilder().From.NpcLootTable().ToSql(),
            new QueryBuilder().From.NpcSpawnRule().ToSql(),
            new QueryBuilder().From.NpcTradeOffer().ToSql(),
            new QueryBuilder().From.PlacedStructure().ToSql(),
            new QueryBuilder().From.Player().ToSql(),
            new QueryBuilder().From.ServiceIdentity().ToSql(),
    ...
    public sealed class From
    {
        ...
        public global::SpacetimeDB.Table<DamageEvent, DamageEventCols, DamageEventIxCols> DamageEvent() => new("damage_event", new DamageEventCols("damage_event"), new DamageEventIxCols("damage_event"));
        ...
        public global::SpacetimeDB.Table<NpcConfig, NpcConfigCols, NpcConfigIxCols> NpcConfig() => new("npc_config", new NpcConfigCols("npc_config"), new NpcConfigIxCols("npc_config"));
        public global::SpacetimeDB.Table<NpcLootTable, NpcLootTableCols, NpcLootTableIxCols> NpcLootTable() => new("npc_loot_table", new NpcLootTableCols("npc_loot_table"), new NpcLootTableIxCols("npc_loot_table"));
        public global::SpacetimeDB.Table<NpcSpawnRule, NpcSpawnRuleCols, NpcSpawnRuleIxCols> NpcSpawnRule() => new("npc_spawn_rule", new NpcSpawnRuleCols("npc_spawn_rule"), new NpcSpawnRuleIxCols("npc_spawn_rule"));
        public global::SpacetimeDB.Table<NpcTradeOffer, NpcTradeOfferCols, NpcTradeOfferIxCols> NpcTradeOffer() => new("npc_trade_offer", new NpcTradeOfferCols("npc_trade_offer"), new NpcTradeOfferIxCols("npc_trade_offer"));
        ...
        public global::SpacetimeDB.Table<ServiceIdentity, ServiceIdentityCols, ServiceIdentityIxCols> ServiceIdentity() => new("service_identity", new ServiceIdentityCols("service_identity"), new ServiceIdentityIxCols("service_identity"));
    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            {
                Reducer.CleanupDamageEvents args => Reducers.InvokeCleanupDamageEvents(eventContext, args),
                ...
                Reducer.NpcDealDamage args => Reducers.InvokeNpcDealDamage(eventContext, args),
                ...
                Reducer.PlayerAttackNpc args => Reducers.InvokePlayerAttackNpc(eventContext, args),
                Reducer.PlayerAttackPlayer args => Reducers.InvokePlayerAttackPlayer(eventContext, args),
                Reducer.RegisterServiceIdentity args => Reducers.InvokeRegisterServiceIdentity(eventContext, args),
